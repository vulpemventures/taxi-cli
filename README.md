...
Create and print to console a base64 encoded PSET (Partial Signed Elements Transaction). It will fund a transaction with an input of `asset` greater than the given `amount`. It will add a change output to `from` address and an outout for `to` address. If the `from` address containes confidential utxos, you MUST pass also the `blinding` flag

```sh
$ taxi-cli create \
    -from ert1qnmlfhvhvy0zfnuptyl4rljys7kuxgdel94p0du \
    -to ert1qeq52ql6cq6qs2j7xctylppzmy4aaekrxekqlt5 \
    -amount 500000 \
    -asset fd1a64da7a909b648319bc070e6f4d70ad1b515d70aa3183fcb137500e9670be \
    -regtest
```
...
```sh
$ taxi-cli topup \
    -pset  \
    -asset fd1a64da7a909b648319bc070e6f4d70ad1b515d70aa3183fcb137500e9670be
```
